(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function PL(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_session_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var StartComponent = /*#__PURE__*/function () {
        function StartComponent(sessionService, authService, router, facebook, alertController) {
        ...
        _createClass(StartComponent, [{
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      this.facebook.login(['email', 'public_profile']).then(function (value) {
                        console.log("Login success", value);

                        _this.facebook.getCurrentProfile().then(function (profile) {
                          console.log(profile);
                        });

                        _this.facebook.api('me?fields=id,name,email', []).then(function (pic) {
                              ...
                              while (1) {
                                switch (_context.prev = _context.next) {
                                  case 0:
                                    ...
                                    facebookSession = JSON.stringify(pic);
                                    this.sessionService.getUserLoginWithFB(facebookSession).subscribe(function (resp) {
                                      console.log(resp);
                                      setTimeout(function () {
                                        ...
                                        if (resp.statusID == 200) {
                                          setTimeout(function () {
                                            _this2.authService.setAuth(true);

                                            var autenticado = _this2.authService.isAuthFunction();
          ...
          value: function loginGuest() {
            ...
            this.router.navigateByUrl('/tabs/tab1');*/
            this.authService.setAuth(true);
            var autenticado = this.authService.isAuthFunction();
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Users/alanramirez/Desktop/ActivaMerca/GitHub/ElRoble/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    /***/
    function IeiB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LocalOrder", function () {
        return LocalOrder;
      });
      /* harmony export (binding) */
      ...
      __webpack_require__.d(__webpack_exports__, "UserNotificationsResponseData", function () {
        return UserNotificationsResponseData;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "UserNotifications", function () {
        return UserNotifications;
      });

      var LocalOrder = function LocalOrder() {
        _classCallCheck(this, LocalOrder);
      };
      ...
      var UserNotificationsResponseData = function UserNotificationsResponseData() {
        _classCallCheck(this, UserNotificationsResponseData);
      };
    ...
    /***/
    function IfdK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var SessionService = /*#__PURE__*/function () {
        ...
        _createClass(SessionService, [{
          key: "postUser",
          value: function postUser(user, action) {
            var _this3 = this;

            return this.http.post("".concat(URL, "/service_session.php?action=").concat(action), user, {
              headers: {
                'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
              }
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
              if (resp.statusID == 200) {
                _this3.setLocalUser(resp.data[0]);
              }
          ...
          key: "getUserLogin",
          value: function getUserLogin(loginUser) {
            var _this4 = this;

            return this.http.post("".concat(URL, "/service_session.php?action=get"), loginUser, {
              headers: {
                'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
              }
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
              if (resp.statusID == 200) {
                _this4.setLocalUser(resp.data[0]);
              }
          ...
          value: function recoverPassword(email) {
            return this.http.get("".concat(URL, "/service_recoverPassword.php?Action=send&email=").concat(email));
          }
          /**
           * Local functions
           */
          ...
          key: "setLocalUser",
          value: function setLocalUser(user) {
            var userArrayString = JSON.stringify(user);
          ...
          key: "closeLocalUser",
          value: function closeLocalUser() {
            localStorage.removeItem('userArray');
          }
        }, {
          key: "getUserLoginWithFB",
          value: function getUserLoginWithFB(loginUser) {
            var _this5 = this;

            console.log(loginUser);
            return this.http.post("".concat(URL, "/service_facebookLogin.php?"), loginUser, {
              headers: {
                'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
              }
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
              if (resp.statusID == 200) {
                _this5.setLocalUser(resp.data[0]);
              }
    ...
    function KWWs(module, __webpack_exports__, __webpack_require__) {
      ...
      var NotificationsService = /*#__PURE__*/function () {
        ...
        _createClass(NotificationsService, [{
          ...
          value: function getNotifications(ID_User) {
            return this.http.get("".concat(URL, "/service_notifications.php?action=listAllByUserID&ID_User=").concat(ID_User));
          }
        }]);
      ...
      var OrdersService = /*#__PURE__*/function () {
        ...
        _createClass(OrdersService, [{
          ...
          value: function postOrder(order) {
            console.log(order);
            return this.http.post("".concat(URL, "/service_orders.php?action=create"), order, {
              headers: {
                'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
              }
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
          ...
          key: "getOrdersHistory",
          value: function getOrdersHistory(ID_User) {
            return this.http.get("".concat(URL, "/service_orders.php?action=listAllByUserID&ID_User=").concat(ID_User));
          }
          ...
          key: "getLocalOrderString",
          value: function getLocalOrderString() {
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var _interfaces_interfaces__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./interfaces/interfaces */
      "IeiB");
      /* harmony import */


      var _ionic_native_power_management_ngx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! @ionic-native/power-management/ngx */
      "VWz1");
      /* harmony import */
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(localNotifications, sessionService, backgroundMode, platform, powerManagement, notificationsService) {
        ...
        _createClass(AppComponent, [{
          ...
          value: function initializeApp() {
            ...
            this.platform.ready().then(function () {
              ...
              _this6.backgroundMode.disableWebViewOptimizations();

              _this6.backgroundMode.disableBatteryOptimizations();

              _this6.powerManagement.acquire().then(function () {//alert('powerManagement acquired');
              })["catch"](function () {//alert('Failed to powerManagement acquired');
              });

              _this6.powerManagement.dim().then(function () {//alert('powerManagement dim');
              })["catch"](function () {// alert('Failed to powerManagement dim');
              });

              _this6.powerManagement.setReleaseOnPause(false).then(function () {//alert('powerManagement setReleaseOnPause');
              })["catch"](function () {//alert('Failed to powerManagement setReleaseOnPause');
              });

              setInterval(function () {
                _this6.backgroundMode.wakeUp();

                _this6.backgroundMode.moveToForeground();

                _this6.user = _this6.sessionService.getLocalUser();

                if (_this6.user) {
                  _this6.notificationsService.getNotifications(_this6.user.ID_User).subscribe(function (response) {
                    _this6.notifications = response.data[0].Notifications;

                    if (_this6.notifications) {
                      for (var i = 0; i < _this6.notifications.length; i++) {
                        _this6.localNotifications.schedule({
                          id: _this6.notifications[i].ID_Notification,
                          text: _this6.notifications[i].Message,
                          data: {
                            secret: 'Hello'
                          }
                        });
    ...
    function W3Zi(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_interfaces_interfaces__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/interfaces/interfaces */
      "IeiB");
      /* harmony import */
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(modalCtrl, navController, router, sessionService, loadingController, alertController) {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function login() {
            ...
            this.serverProcess = true;
            console.log("Login");
            var loginUser = new src_app_interfaces_interfaces__WEBPACK_IMPORTED_MODULE_6__["UserModel"]();
            loginUser.Email = this.loginEmail;
            loginUser.Password = this.loginPassword;
            console.log(loginUser);
            this.sessionService.getUserLogin(loginUser).subscribe(function (resp) {
              console.log(resp);
              setTimeout(function () {
                _this7.serverProcess = false;

                if (resp.statusID == 200) {
                  _this7.closeLoginComponent("refresh");
                } else {
          ...
          value: function register() {
            ...
            this.serverProcess = true;
            this.sessionService.postUser(this.user, "create").subscribe(function (resp) {
              console.log(resp);
              setTimeout(function () {
                _this8.serverProcess = false;

                if (resp.statusID == 200) {
                  _this8.closeLoginComponent("refresh");
                } else {
                  _this8.presentAlert(resp.statusName, resp.statusDescription);
                }
              }, 1500);
            });
          }
          ...
          value: function recovery() {
            ...
            this.serverProcess = true;
            this.sessionService.recoverPassword(this.recoveryEmail).subscribe(function (resp) {
              console.log(resp);
              setTimeout(function () {
                _this9.serverProcess = false;

                if (resp.statusID == 200) {
                  _this9.presentAlert(resp.statusName, resp.statusDescription);

                  _this9.recoveryEmail = "";
                } else {
                  _this9.presentAlert(resp.statusName, resp.statusDescription);
                }
              }, 1500);
          ...
          key: "closeLoginComponent",
          value: function closeLoginComponent() {
    ...
    function XnsX(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_local_toasts_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var ExploreContainerComponent = /*#__PURE__*/function () {
        function ExploreContainerComponent(ordersService, localToastsController, router) {
        ...
        _createClass(ExploreContainerComponent, [{
          ...
          value: function calculateTotalPrice() {
            ...
            this.orderProductsArray.forEach(function (product, index) {
              _this10.totalOrderPrice = _this10.totalOrderPrice + product.Total;
            });
      ...
      ExploreContainerComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["Component"])({
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ionic_native_power_management_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! @ionic-native/power-management/ngx */
      "VWz1");
      /* harmony import */


      var _ionic_native_facebook_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! @ionic-native/facebook/ngx */
      "GGTb");
    ...
    /***/
    function qTK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LocalToastsService", function () {
        return LocalToastsService;
      });
      /* harmony import */
      ...
      var LocalToastsService = /*#__PURE__*/function () {
        function LocalToastsService(toastController) {
          _classCallCheck(this, LocalToastsService);

          this.toastController = toastController;
        }

        _createClass(LocalToastsService, [{
          key: "presentToast",
      ...
      LocalToastsService.ctorParameters = function () {
        return [{
          type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"]
        }];
      };

      LocalToastsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], LocalToastsService);
      /***/
    },
    ...
    function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_start_start_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _pages_explore_container_explore_container_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./pages/explore-container/explore-container.component */
      "XnsX");
      ...
      var routes = [{
        ...
        path: 'ExploreContainer',
        component: _pages_explore_container_explore_container_component__WEBPACK_IMPORTED_MODULE_6__["ExploreContainerComponent"]
      }];
