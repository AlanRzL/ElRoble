(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab2-tab2-module"], {
    ...
    function AEsy(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_components_login_login_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/components/login/login.component */
      "W3Zi");
      /* harmony import */


      var src_app_components_order_details_order_details_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/components/order-details/order-details.component */
      "pWPZ");
      /* harmony import */
      ...
      var Tab2Page = /*#__PURE__*/function () {
        function Tab2Page(modalCtrl, sessionService, ordersService, localToastsController, alertController) {
        ...
        _createClass(Tab2Page, [{
          ...
          value: function getOrdersHistory() {
            var _this2 = this;

            this.serverProcess = true;
            this.ordersService.getOrdersHistory(this.user.ID_User).subscribe(function (resp) {
              setTimeout(function () {
                _this2.serverProcess = false;

                if (resp.statusID == 200) {
                  _this2.ordersHistoryArray = resp.data;
                  console.log(_this2.ordersHistoryArray);
                } else {
                  _this2.ordersHistoryArray = [];
    ...
    function HJB(module, __webpack_exports__, __webpack_require__) {
      ...
      Tab2PageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _explore_container_explore_container_module__WEBPACK_IMPORTED_MODULE_6__["ExploreContainerComponentModule"], _tab2_routing_module__WEBPACK_IMPORTED_MODULE_7__["Tab2PageRoutingModule"], src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_8__["PipesModule"]],
